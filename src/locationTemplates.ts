...
export function linkSheetPage() {
  ...
  return shell("Xagio pSEO LinkSheet Authority Hub | Service Directory", "Official interlinking LinkSheet directory for nationwide home services, arborist care, garage door repairs, pest control, and plumbing.", canonical, body);
}
